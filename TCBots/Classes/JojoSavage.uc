...
// Researcher.
//=============================================================================
class JojoSavage extends DXHumanMilitary;
...
defaultproperties
{
	...
	sHunting=sound'DeusExConAudioAIBarks.ConAudioAIBarks_92'
     ...
     InitialInventory(1)=(Inventory=Class'WeaponCrowbar')
     ...
     BindName="JojoSavage"
     BarkBindName="JojoSavage"
     FamiliarName="Jojo Savage"
     UnfamiliarName="Jojo Savage"
