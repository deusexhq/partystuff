...
// Researcher.
//=============================================================================
class AugResearcher extends DXEnemy;
...
defaultproperties
{
	...
	sHunting=sound'DeusExConAudioAIBarks.ConAudioAIBarks_1378'
     ...
     MultiSkins(3)=Texture'DeusExCharacters.Skins.AnnaNavarreTex0'
     ...
     BindName="AugResearcher"
     BarkBindName="AugResearcher"
     FamiliarName="Augmented Researcher"
     UnfamiliarName="Augmented Researcher"
