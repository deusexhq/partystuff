...
{     
	...
	tScanning="Come on out, punk."
	tTargetAcquired="Got you, jackass."
	tTargetLost="You can't hide forever."
	tCriticalDamage="Tcht, a flesh wound, nothing to worry about!"
	tAreaSecure="This is MY turf.."
	tBossArmourDown="You think taking out my Boss Armour will help you?"
	tBossArmourBack="Good, my armours back."
	tMedkitUsed="Can't out-damage my medkits, punk."
	tCallingBackup="Get 'em, boys!"
	Medkits=5
	bReturnArmour=True
	ReturnArmour=100
	bHasCloakX=True
	InitialAlliances(3)=(AllianceName=Forgotten,AllianceLevel=1.000000)
     ...
     InitialInventory(1)=(Inventory=Class'Ammo762mm', Count=999)
     ...
     HealthArmRight=900
     BindName="Forgotten"
	 nameArticle="The Forgotten Lord,"
     FamiliarName="Mal"
     UnfamiliarName="Mal"
