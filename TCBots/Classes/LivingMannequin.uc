...
// DarkMaiden.
//=============================================================================
class LivingMannequin extends DXEnemy;

function PostBeginPlay()
{
	if(Multiskins[0] != Texture'DeusExItems.Skins.GrayMaskTex')
	{
		Texture=Texture'DeusExItems.Skins.PinkMaskTex';
	}
	
	if(mesh==Mesh'DeusExCharacters.GM_Jumpsuit')
	{
		Texture=Texture'DeusExItems.Skins.PinkMaskTex';
...
local Mannequin EC;
	...
	if(Multiskins[0] != Texture'DeusExItems.Skins.GrayMaskTex')
	{
		EC.Texture=Texture'DeusExItems.Skins.PinkMaskTex';
	}
