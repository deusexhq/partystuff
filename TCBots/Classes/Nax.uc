...
// DarkMaiden.
//=============================================================================
class Nax extends DXEnemy;

var NaxSphere NS;

function PostBeginPlay()
{
BroadcastMessage("Nax has appeared.");
super.PostBeginPlay();
}
...
AllianceGroup="Admins"
	 ...
	 InitialAlliances(3)=(AllianceName=DarkoE,AllianceLevel=-1.000000)
     InitialAlliances(4)=(AllianceName=Fits,AllianceLevel=-1.000000)
