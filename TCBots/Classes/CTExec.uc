class CTExec extends DXHumanMilitary;
...
defaultproperties
{
	...
	BossArmour=150
	bBossArmour=True
     CarcassType=Class'ctExecCarcass'
     WalkingSpeed=0.296000
     InitialInventory(0)=(Inventory=Class'Weaponstealthpistol')
     InitialInventory(1)=(Inventory=Class'DeusEx.Ammo10mm',Count=120)
     ...
     MultiSkins(2)=Texture'CTExecTex1'//Texture'DeusExCharacters.Skins.PhilipMeadTex1'
     ...
     BindName="Exec"
     FamiliarName="Executive Agent"
     UnfamiliarName="Executive Agent"
}
