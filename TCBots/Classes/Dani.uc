...
{     
	...
	InitialAlliances(4)=(AllianceName=DarkoE,AllianceLevel=-1.000000)
     scoreCredits=15
     ...
     HealthArmRight=300
     BindName="Forgotten"
	 nameArticle="The Forgotten Troll,"
     FamiliarName="Dani Saggenza"
     UnfamiliarName="Dani Saggenza"
