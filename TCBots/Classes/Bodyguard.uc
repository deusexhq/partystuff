...
// SecurityForce.
//=============================================================================
class Bodyguard extends DXHumanMilitary;
...
function Frob(Actor Frobber, Inventory frobWith)
{
   ...
   if (DeusExPlayer(Frobber) == None)
	...
	if(myOwner == None)
	{
		...
		myOwner.ClientMessage("Bodyguard now following you.");
		FamiliarName = myOwner.PlayerReplicationInfo.PlayerName$"'s Bodyguard";
		GotoState('following');
	}
	else
	{
		...
		{
			myOwner.ClientMessage("Not following.");
			myOwner=None;
